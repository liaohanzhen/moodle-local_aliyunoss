 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class admin_settings_aliyunoss_region extends \admin_setting_configtext {
    ...
    public function output_html($data, $query='') {
        ...
        $all = require($CFG->dirroot . '/local/aliyunoss/sdk/Aws/data/endpoints.json.php');
